...
def parse_args():
    ...
    # mandatory arguments
    parser.add_argument('--env_type', type=str, choices=['atari', 'ocatari', 'minigrid', 'gym', 'mujoco', 'football', 'openspiel', 'bsuite', 'highway', 'carl']) 
...
def get_defaults(args, defaults):
    ...
    # args.env_name = args.env_name if args.env_name else 'MiniGrid-KeyCorridorS3R1-v0'
    # args.env_name = args.env_name if args.env_name else 'academy_3_vs_1_with_keeper_far_bot'
