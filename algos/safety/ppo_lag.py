    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                # Normalize advantage. Done identically whether or not the mask
                # is on: the label routes the *loss*, never the advantage
                # estimate, so both streams keep the baseline's statistics.
