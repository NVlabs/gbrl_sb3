...
class PPOLagGBRL(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        # instead of blending them into one Lagrangian stream. This is the
        # same-function-class counterpart to Split-RL's structural routing.
    ...
    def train(self) -> None:
        ...
        for _ in range(self.n_epochs):
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                # Normalisation is identical with and without the mask: the
                # label routes the loss, never the advantage estimate.
