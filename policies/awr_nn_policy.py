...
class Actor(BasePolicy):
    ...
    def get_distribution(self, obs: th.Tensor) -> Distribution:
        ...
        # print('features: ', features, 'features.shape: ', features.shape)
        latent_pi = self.latent_pi(features)
        # print(f'latent_pi: {latent_pi.shape} -> {latent_pi}')
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor) -> Distribution:
        ...
        # print(f'mean_actions: {mean_actions.shape }-> {mean_actions}' )

        # print(th.isnan(mean_actions).any())
...
class AWRPolicy(BasePolicy):
    ...
    def __init__(
        ...
        if optimizer_kwargs and 'critic_lr' in optimizer_kwargs.keys():
            self.critic_lr = optimizer_kwargs['critic_lr']
            del optimizer_kwargs['critic_lr']
        if optimizer_kwargs and 'actor_lr' in optimizer_kwargs.keys():
...
class MultiInputPolicy(AWRPolicy):
    """
    Policy class (with both actor and critic) for AWR.
