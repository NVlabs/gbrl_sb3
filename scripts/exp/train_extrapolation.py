...
from env.extrapolation import register_extrapolation_tests
...
if __name__ == '__main__':
    ...
    if args.evaluate:
        eval_name = args.env_name.replace('train', 'test')
        eval_env = make_vec_env(eval_name, n_envs=1, env_kwargs=args.env_kwargs)
        if args.wrapper == 'normalize': 
